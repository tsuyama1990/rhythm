...
class JQuantsClient:
    ...
    def __init__(self, mail_address: Optional[str] = None, password: Optional[str] = None):
        ...
        if not self.mail_address or not self.password:
            raise ValueError("JQUANTS_MAIL_ADDRESS and JQUANTS_PASSWORD must be provided or set in environment variables.")
    ...
    def fetch_daily_quotes(self, code: Optional[str] = None, date: Optional[str] = None, from_date: Optional[str] = None, to_date: Optional[str] = None) -> List[Dict]:
